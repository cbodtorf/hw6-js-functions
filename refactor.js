...
// The answer is [c], because of the timeout set to the function.
// $letter is assigned the value 'z' and then logged immediately,
// then the timeout function runs assigning $letter to 'y'.
// 'x' never gets a chance to be logged.
...
var spanishColor = function(colorName) {
  ...
  return myObj[colorName.toLowerCase()];
}
...
//any number including 0 (which speed is set to) + undefined returns NaN;
